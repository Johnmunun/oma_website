...
export const FORMATIONS: Formation[] = [
  ...
  },
  {
    ...
    name: "Formation de Prise de parole en public",
    description:
      "Développez votre capacité à inspirer et mobiliser votre audience à travers une communication efficace et captivante.",
