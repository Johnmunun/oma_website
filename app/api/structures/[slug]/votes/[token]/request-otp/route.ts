/**
 * POST /api/structures/[slug]/votes/[token]/request-otp
 */
...
export async function POST(
  ...
  try {
    ...
    await requestPublicVoteOtpByToken(slug, token, body.email)
    ...
    console.error('[API] Erreur request-otp short vote:', error)
    return NextResponse.json(
