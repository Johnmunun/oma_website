...
function AnalyticsStatCard({
  ...
  return (
    <Card className="p-6 hover:shadow-xl transition-all duration-300 ease-out cursor-pointer border-0 shadow-soft bg-white rounded-2xl hover:scale-[1.03] active:scale-[0.98] group relative overflow-hidden">
      ...
      <div className="flex items-center justify-between relative z-10">
        <div>
          <p className="text-sm text-muted-foreground font-medium transition-colors duration-200 group-hover:text-foreground">{label}</p>
          <p className="text-3xl font-bold mt-2 transition-transform duration-200 group-hover:scale-105">{value.toLocaleString()}</p>
          {change && (
            <p className="text-xs text-green-600 mt-2 transition-all duration-200 group-hover:scale-110">
              <span className="inline-block transition-transform duration-200 group-hover:translate-y-[-2px]">↑</span> {change}
            </p>
          )}
        </div>
        <div className="p-3 bg-primary/10 rounded-lg transition-all duration-300 group-hover:scale-110 group-hover:rotate-6 group-hover:bg-primary/20 group-hover:shadow-lg">
          <Icon className="w-6 h-6 text-primary transition-transform duration-300 group-hover:scale-110 group-hover:rotate-[-5deg]" />
        </div>
      </div>
