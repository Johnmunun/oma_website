...
export function FormationCard({ formation }: FormationCardProps) {
  ...
  return (
    <div className="bg-card rounded-lg overflow-hidden shadow-lg border border-border hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group flex flex-col card-scale-hover">
        ...
        <div className="border-t border-border pt-4 mt-auto">
          ...
          <Dialog open={showCheckout} onOpenChange={setShowCheckout}>
            <DialogTrigger asChild>
              <Button className="w-full bg-gold hover:bg-gold-dark text-primary button-gold-glow group">
                <ShoppingCart className="mr-2 h-4 w-4 transition-transform duration-200 group-hover:scale-110 group-hover:rotate-12" />
