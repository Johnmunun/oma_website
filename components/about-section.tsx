      ...
      <div className="container mx-auto px-4">
        <AnimateOnScroll animation="fade-up" delay={100}>
          <div className="max-w-4xl mx-auto text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-gold/10 text-gold-text px-4 py-2 rounded-full mb-6">
            ...
            <blockquote className="text-2xl font-serif italic text-gold-text border-l-4 border-gold pl-6 my-8">
