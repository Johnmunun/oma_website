      ...
      <div className="border-2 border-dashed border-border rounded-lg p-8 text-center hover:bg-muted/50 transition-colors min-h-[200px] flex items-center justify-center bg-card">
        {preview ? (
          <div className="relative inline-flex items-center justify-center">
            ...
            <div className="absolute w-24 h-24 bg-gradient-to-br from-white via-white to-gray-50 rounded-2xl shadow-lg shadow-black/10 border-2 border-white/50 z-0" />
            {/* Logo par-dessus avec meilleure qualité */}
            <div className="relative z-10 p-2">
              <img 
                src={preview} 
                alt="Logo preview" 
                className="h-20 max-w-full object-contain drop-shadow-sm" 
              />
            </div>
          </div>
        ) : (
